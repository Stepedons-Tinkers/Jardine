<?php /* Smarty version 2.6.18, created on 2014-05-17 13:17:17
         compiled from Settings/LayoutBlockEntries.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'vtiger_imageurl', 'Settings/LayoutBlockEntries.tpl', 24, false),array('modifier', 'getTranslatedString', 'Settings/LayoutBlockEntries.tpl', 71, false),array('modifier', 'cat', 'Settings/LayoutBlockEntries.tpl', 415, false),array('modifier', 'count', 'Settings/LayoutBlockEntries.tpl', 442, false),)), $this); ?>
...
"	href="javascript:void(0);" class="customMnu" style="text-decoration:none; background-image:url(<?php echo vtiger_imageurl('time.PNG', $this->_tpl_vars['THEME']); ?>
                                                                                                ...
                                                                                                <tr id="addfield_<?php echo $this->_tpl_vars['entries']['blockid']; ?>
_datetimeField" style="display:none"><td align="left"><a id="field14_<?php echo $this->_tpl_vars['entries']['blockid']; ?>
"	href="javascript:void(0);" class="customMnu" style="text-decoration:none; background-image:url(<?php echo vtiger_imageurl('date.gif', $this->_tpl_vars['THEME']); ?>
);" 		onclick = "makeFieldSelected(this,14,<?php echo $this->_tpl_vars['entries']['blockid']; ?>
);"> DateTime </a></td></tr>
																								<tr id="addfield_<?php echo $this->_tpl_vars['entries']['blockid']; ?>
_relationField" style="display:none"><td align="left"><a id="field15_<?php echo $this->_tpl_vars['entries']['blockid']; ?>
"	href="javascript:void(0);" class="customMnu" style="text-decoration:none; background-image:url(<?php echo vtiger_imageurl('text.gif', $this->_tpl_vars['THEME']); ?>
...
"  value="" type="text" class="txtBox">
																				...
																				<!-- ed edited for not custom field -->
																				<tr id='addfield_<?php echo $this->_tpl_vars['entries']['blockid']; ?>
_colNameForNCustom' style="display:none">
																					<td class="dataLabel" nowrap="nowrap" align="right" width="30%"><b>Col Name: </b>
																					</td>
																					<td align="left" width="70%">
																					<input id="colName_<?php echo $this->_tpl_vars['entries']['blockid']; ?>
"  value="" type="text" class="txtBox">
																					</td>
																				</tr>
																				<!-- ed edited end -->
