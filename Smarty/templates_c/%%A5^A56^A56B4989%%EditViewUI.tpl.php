<?php /* Smarty version 2.6.18, created on 2014-05-17 11:31:22
...
>
		...
		<?php elseif ($this->_tpl_vars['uitype'] == 2356): ?>				<td width="20%" class="dvtCellLabel" align=right>
				<font color="red"><?php echo $this->_tpl_vars['mandatory_field']; ?>
</font><?php echo $this->_tpl_vars['usefldlabel']; ?>
...
" tabindex="<?php echo $this->_tpl_vars['vt_tab']; ?>
" id="jscal_field_<?php echo $this->_tpl_vars['fldname']; ?>
" type="text" style="border:1px solid #bababa;" size="21" maxlength="20" value="<?php echo $this->_tpl_vars['date_val']; ?>
">
...
?>
					...
					<?php $this->assign('dateStr', ($this->_tpl_vars['date_str'])); ?>
				<?php endforeach; endif; unset($_from); ?>				
				<br><font size=1><em old="(yyyy-mm-dd HH:MM:SS)">(<?php echo $this->_tpl_vars['dateStr']; ?>
)</em></font>
...
'>
					Calendar.setup ({
						inputField : "jscal_field_<?php echo $this->_tpl_vars['fldname']; ?>
", ifFormat : "<?php echo $this->_tpl_vars['dateFormat']; ?>
", showsTime : true, timeFormat  : "24", button : "jscal_trigger_<?php echo $this->_tpl_vars['fldname']; ?>
", singleClick : true, step : 1
					})
				</script>
			</td>
