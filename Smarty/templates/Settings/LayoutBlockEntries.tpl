																	...
																	<tr>
																					...
																					<td>
																						<div name="cfcombo" id="cfcombo" class="small"  style="width:205px; height:150px; overflow-y:auto ;overflow-x:hidden ;overflow:auto; border:1px  solid #CCCCCC ;">
																							<table>
                                                                                                ...
                                                                                                <tr id="addfield_{$entries.blockid}_datetimeField" style="display:none"><td align="left"><a id="field14_{$entries.blockid}"	href="javascript:void(0);" class="customMnu" style="text-decoration:none; background-image:url({'date.gif'|@vtiger_imageurl:$THEME});" 		onclick = "makeFieldSelected(this,14,{$entries.blockid});"> DateTime </a></td></tr>
																								<tr id="addfield_{$entries.blockid}_relationField" style="display:none"><td align="left"><a id="field15_{$entries.blockid}"	href="javascript:void(0);" class="customMnu" style="text-decoration:none; background-image:url({'text.gif'|@vtiger_imageurl:$THEME});" 		onclick = "makeFieldSelected(this,'relation',{$entries.blockid});"> Relation </a></td></tr>
																							</table>
																						</div>	
																					</td>
																				</tr>
																		...
																		<td width="50%">
																			<table width="100%" border="0" cellpadding="5" cellspacing="0">
																				...
																				<!-- ed edited for not custom field -->
																				<tr id='addfield_{$entries.blockid}_colNameForNCustom' style="display:none">
																					<td class="dataLabel" nowrap="nowrap" align="right" width="30%"><b>Col Name: </b>
																					</td>
																					<td align="left" width="70%">
																					<input id="colName_{$entries.blockid}"  value="" type="text" class="txtBox">
																					</td>
																				</tr>
																				<!-- ed edited end -->
