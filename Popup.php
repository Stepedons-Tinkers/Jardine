...
else
{
	...
	if($currentModule == 'XBusinessUnit'){
	...
	else if($currentModule == 'XCustomers'){
		$where_relquery .=" and vtiger_xcustomers.z_cu_isactive='1'";
	}	
	else if($currentModule == 'XActivityType'){
		...
		$where_relquery .=" and vtiger_xsupplier.z_sup_isactive='1'";
	}	
	else if($currentModule == 'XCompetitor'){
		$where_relquery .=" and vtiger_xcompetitor.z_cm_isactv='1'";
	}		
	else if($currentModule == 'XCompetitorProd'){
		$where_relquery .=" and vtiger_xcompetitorprod.z_cmp_isactive='1'";
	}		
	else if($currentModule == 'XEventProtocol'){
		$where_relquery .=" and vtiger_xeventprotocol.z_evp_isactv='1'";
	}	
	else if($currentModule == 'XMarketingMat'){
		$where_relquery .=" and vtiger_xmarketingmat.z_mm_isactv='1'";
	}	
	else if($currentModule == 'XSMR'){
		$where_relquery .=" and vtiger_xsmr.z_smr_isactv='1'";
	}	
	//ed edited end
