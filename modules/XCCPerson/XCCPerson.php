<?php/*+********************************************************************************** * The contents of this file are subject to the vtiger CRM Public License Version 1.0 * ("License"); You may not use this file except in compliance with the License * The Original Code is:  vtiger CRM Open Source * The Initial Developer of the Original Code is vtiger. * Portions created by vtiger are Copyright (C) vtiger. * All Rights Reserved. ************************************************************************************/require_once('data/CRMEntity.php');require_once('data/Tracker.php');class XCCPerson extends CRMEntity {	var $db, $log; // Used in class functions of CRMEntity	var $table_name = 'vtiger_xccperson';	var $table_index= 'xccpersonid';	var $column_fields = Array();	/** Indicator if this is a custom module or standard module */	var $IsCustomModule = true;	/**	 * Mandatory table for supporting custom fields.	 */	var $customFieldTable = Array('vtiger_xccpersoncf', 'xccpersonid');	var $related_tables = Array ('vtiger_xccpersoncf' => Array('xccpersonid'));	/**	 * Mandatory for Saving, Include tables related to this module.	 */	var $tab_name = Array('vtiger_crmentity', 'vtiger_xccperson', 'vtiger_xccpersoncf');	/**	 * Mandatory for Saving, Include tablename and tablekey columnname here.	 */	var $tab_name_index = Array(		'vtiger_crmentity' => 'crmid',		'vtiger_xccperson'   => 'xccpersonid',	    'vtiger_xccpersoncf' => 'xccpersonid');		/**	 * Mandatory for Listing (Related listview)	 */	var $list_fields = Array (		/* Format: Field Label => Array(tablename, columnname) */		// tablename should not have prefix 'vtiger_'		'CRM No' => Array('xccperson','z_cuc_crmno'),'First Name' => Array('xccperson','z_cuc_firstname'),'Last Name' => Array('xccperson','z_cuc_lastname'),'Position' => Array('xccperson','z_cuc_position'),'Mobile No' => Array('xccperson','z_cuc_mobileno')	);	var $list_fields_name = Array(		/* Format: Field Label => fieldname */		'CRM No' => 'z_cuc_crmno','First Name' => 'z_cuc_firstname','Last Name' => 'z_cuc_lastname','Position' => 'z_cuc_position','Mobile No' => 'z_cuc_mobileno'	);	// Make the field link to detail view from list view (Fieldname)	var $list_link_field = 'z_cuc_crmno';	// For Popup listview and UI type support	var $search_fields = Array(		/* Format: Field Label => Array(tablename, columnname) */		// tablename should not have prefix 'vtiger_'		'CRM No' => Array('xccperson','z_cuc_crmno'),'First Name' => Array('xccperson','z_cuc_firstname'),'Last Name' => Array('xccperson','z_cuc_lastname'),'Position' => Array('xccperson','z_cuc_position'),'Mobile No' => Array('xccperson','z_cuc_mobileno')	);	var $search_fields_name = Array(		/* Format: Field Label => fieldname */		'CRM No' => 'z_cuc_crmno','First Name' => 'z_cuc_firstname','Last Name' => 'z_cuc_lastname','Position' => 'z_cuc_position','Mobile No' => 'z_cuc_mobileno'	);	// For Popup window record selection	var $popup_fields = Array('z_cuc_crmno');	// Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields	var $sortby_fields = Array();	// For Alphabetical search	var $def_basicsearch_col = 'z_cuc_crmno';	// Column value to use on detail view record text display	var $def_detailview_recname = 'z_cuc_crmno';	// Required Information for enabling Import feature	var $required_fields = Array('z_cuc_crmno'=>1);	// Callback function list during Importing	var $special_functions = Array('set_import_assigned_user');	var $default_order_by = 'z_cuc_crmno';	var $default_sort_order='ASC';	// Used when enabling/disabling the mandatory fields for the module.	// Refers to vtiger_field.fieldname values.	var $mandatory_fields = Array('createdtime', 'modifiedtime', 'z_cuc_crmno');
