<?php/*+********************************************************************************** * The contents of this file are subject to the vtiger CRM Public License Version 1.0 * ("License"); You may not use this file except in compliance with the License * The Original Code is:  vtiger CRM Open Source * The Initial Developer of the Original Code is vtiger. * Portions created by vtiger are Copyright (C) vtiger. * All Rights Reserved. ************************************************************************************/require_once('data/CRMEntity.php');require_once('data/Tracker.php');class XMarketingMat extends CRMEntity {	var $db, $log; // Used in class functions of CRMEntity	var $table_name = 'vtiger_xmarketingmat';	var $table_index= 'xmarketingmatid';	var $column_fields = Array();	/** Indicator if this is a custom module or standard module */	var $IsCustomModule = true;	/**	 * Mandatory table for supporting custom fields.	 */	var $customFieldTable = Array('vtiger_xmarketingmatcf', 'xmarketingmatid');	var $related_tables = Array ('vtiger_xmarketingmatcf' => Array('xmarketingmatid'));	/**	 * Mandatory for Saving, Include tables related to this module.	 */	var $tab_name = Array('vtiger_crmentity', 'vtiger_xmarketingmat', 'vtiger_xmarketingmatcf');	/**	 * Mandatory for Saving, Include tablename and tablekey columnname here.	 */	var $tab_name_index = Array(		'vtiger_crmentity' => 'crmid',		'vtiger_xmarketingmat'   => 'xmarketingmatid',	    'vtiger_xmarketingmatcf' => 'xmarketingmatid');		/**	 * Mandatory for Listing (Related listview)	 */	var $list_fields = Array (		/* Format: Field Label => Array(tablename, columnname) */		// tablename should not have prefix 'vtiger_'		'CRM No' => Array('xmarketingmat','z_mm_crmno'),'Description' => Array('xmarketingmat','z_mm_desc'),'Last Update' => Array('xmarketingmat','z_mm_lastup'),'Tags' => Array('xmarketingmat','z_mm_tags'),'Is Active' => Array('xmarketingmat','z_mm_isactv')	);	var $list_fields_name = Array(		/* Format: Field Label => fieldname */		'CRM No' => 'z_mm_crmno','Description' => 'z_mm_desc','Last Update' => 'z_mm_lastup','Tags' => 'z_mm_tags','Is Active' => 'z_mm_isactv'	);	// Make the field link to detail view from list view (Fieldname)	var $list_link_field = 'z_mm_crmno';	// For Popup listview and UI type support	var $search_fields = Array(		/* Format: Field Label => Array(tablename, columnname) */		// tablename should not have prefix 'vtiger_'		'CRM No' => Array('xmarketingmat','z_mm_crmno'),'Description' => Array('xmarketingmat','z_mm_desc'),'Last Update' => Array('xmarketingmat','z_mm_lastup'),'Tags' => Array('xmarketingmat','z_mm_tags'),'Is Active' => Array('xmarketingmat','z_mm_isactv')	);	var $search_fields_name = Array(		/* Format: Field Label => fieldname */		'CRM No' => 'z_mm_crmno','Description' => 'z_mm_desc','Last Update' => 'z_mm_lastup','Tags' => 'z_mm_tags','Is Active' => 'z_mm_isactv'	);	// For Popup window record selection	var $popup_fields = Array('z_mm_crmno');	// Placeholder for sort fields - All the fields will be initialized for Sorting through initSortFields	var $sortby_fields = Array();	// For Alphabetical search	var $def_basicsearch_col = 'z_mm_crmno';	// Column value to use on detail view record text display	var $def_detailview_recname = 'z_mm_crmno';	// Required Information for enabling Import feature	var $required_fields = Array('z_mm_crmno'=>1);	// Callback function list during Importing	var $special_functions = Array('set_import_assigned_user');	var $default_order_by = 'z_mm_crmno';	var $default_sort_order='ASC';	// Used when enabling/disabling the mandatory fields for the module.	// Refers to vtiger_field.fieldname values.	var $mandatory_fields = Array('createdtime', 'modifiedtime', 'z_mm_crmno');
