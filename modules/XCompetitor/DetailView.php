...
if($current_user->isSupreme || in_array($current_user->rolename, array('Parameter Maintenance Admin','Marketing Manager','Brand Assistant / Marketing Service Assistant'))){
	if($focus->column_fields['z_cm_isactv'] != 1)
